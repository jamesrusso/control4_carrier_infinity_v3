...
if (TEMPLATE_VERSION ~= nil) then
	TEMPLATE_VERSION.c4_serial_connection = "2014.10.31"
end
...
function SerialConnectionBase:SendCommand(sCommand, ...)
	LogTrace("SerialConnectionBase:SendCommand(%s), self._IsConnected = %s, self._BindingID = %s", sCommand, tostring(self._IsConnected), tostring(self._BindingID))
